...
JohnsonSeq::JohnsonSeq(int graph_size) {
    this->graph_size = graph_size;
}

vector<vector<int> >* JohnsonSeq::forward(vector<vector<int> > *graph) {
...
vector<vector<int> >* JohnsonSeq::forward_optimized(vector<vector<int> > *graph) {
...
graph_t* JohnsonSeq::init_adjacency_list(vector<vector<int> > *graph) {
